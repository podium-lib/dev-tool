...
class Status extends React.Component {
  render() {
    let message = "Unable to establish a connection to Podium developer tools";
    let clientVersion = "";
    let apiVersion = "";
    if (!this.props.notFound && !this.props.supported) {
      message = `API and extension version mismatch detected. This version of the extension supports API versions between ${this.props.apiMinVersion} and ${this.props.apiMaxVersion} but the current API version is ${this.props.apiVersion}`;
    }
    if (!this.props.notFound && this.props.supported) message = "Podium developer tools";
    if (this.props.clientVersion) clientVersion = " Extension: v" + this.props.clientVersion;
    if (this.props.apiVersion) apiVersion = " API: v" + this.props.apiVersion;
    return /*#__PURE__*/React.createElement("div", {
      className: "status"
    }, /*#__PURE__*/React.createElement("div", null, message), /*#__PURE__*/React.createElement("div", {
      className: "meta"
  ...
  render() {
    ...
    if (names.length > 1) {
      return /*#__PURE__*/React.createElement("ul", {
        className: "podlet-name-tabs nav nav-pills"
      }, names.map((name, i) => {
...
class Panel extends React.Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement(Context, {
      name: selected,
      data: context,
      onChange: onChange,
      onSave: onSave
...
class Connection extends React.Component {
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "input-group-text"
    }, "port")), /*#__PURE__*/React.createElement("input", {
      type: "text",
      className: "form-control",
      name: "port",
  ...
  async url() {
    if (this.devtools) {
      const url = await new Promise(resolve => {
        window.chrome.devtools.inspectedWindow.eval("window.location", {}, resolve);
      });
      return url.origin;
    } else {
...
const App = () => {
  ...
  })))), state.supported && /*#__PURE__*/React.createElement(Container, {
    data: state.contexts,
    onChange: onChange,
    onSave: onSave
  }));
